...
public class ConstNpc {
        ...
        public static final String HUONG_DAN_BLACK_BALL_WAR = "Mỗi ngày từ 20h đến 21h các hành tinh có Ngọc Rồng Sao Đen sẽ xảy ra 1 cuộc đại chiến\n"
                        ...
                        + "Sau khi Chiến thắng sẽ nhận được những chỉ số thưởng sau :\n"
                        + "1 sao : tăng 10% Sức đánh\n"
                        + "2 sao : tăng 15% HP\n"
                        + "3 sao : tăng 15% KI\n"
                        + "4 sao : tăng 10% Giáp\n"
                        + "5 sao : tăng 10% Né đòn\n"
                        + "6 sao : tăng 10% Sát thương chí mạng\n"
                        + "7 sao : tăng 30 % Tiềm năng và sức mạnh\n"
        ...
        public static final byte BONGBANGOLD = 79;
        public static final byte XE_NUOC_MIA = 80;
        public static final byte BLACKGOKU = 81;
        public static final byte PHUOCTV = 82;
        public static final byte TOP1 = 83;
        public static final byte HANG_NGA = 84;
        public static final byte URON_TRU = 85;
        public static final byte HIT = 86;
        public static final byte MONAITO = 87;
        ...
        public static final int MENU_CHOOSE_SKH = 508;
        ...
        public static final int SUMMON_TORONBO = 520;
        public static final int RUONG_GO = 521;
        public static final int UP_TOP_ITEM = 522;
        public static final int COORDINATES = 523;
        public static final int CONFIRM_DISSOLUTION_CLAN = 523;
        public static final int CONFIRM_DIALOG = 524;
        ...
        public static final int TORONBO = 508;
        ...
        public static final int SHOP_BONG_BANG_GOLD = 526;

        public static final int SHOP_GOKU_SSJ = 527;

        public static final int SHOP_BA_HAT_MIT_4 = 528;

        public static final int SHOP_URON_1 = 529;

        public static final int SHOP_NUOC_MIA = 530;

        public static final int MENU_SKH = 531;

        public static final int BA_HAT_MIT_BLACK = 532;

        public static final int MOC_REWARDS = 533;
