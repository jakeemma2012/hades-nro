...
//        return 10000;
    ...
    public static byte getTempSkillSkillByItemID(int id) {
        ...
        } else if (id >= 1319 && id <= 1323) {
            return Skill.SAYIAN_HOA;
        } else if (id >= 1324 && id <= 1328) {
            return Skill.SAYIAN_HOA_NM;
        } else if (id >= 1329 && id <= 1333) {
            return Skill.SAYIAN_HOA_XD;
        } else if (id == 1315) {
            return Skill.PHAN_TACH_TD;
        } else if (id == 1316) {
            return Skill.PHAN_TACH_NM;
        } else if (id == 1317) {
            return Skill.PHAN_TACH_XD;
        } else {
            return -1;
        }
    }
    ...
    public static Skill getSkillByItemID(Player pl, int tempId) {
        ...
        } else if (tempId >= 1319 && tempId <= 1323) {
            return getSkillbyId(pl, Skill.SAYIAN_HOA);
        } else if (tempId >= 1324 && tempId <= 1328) {
            return getSkillbyId(pl, Skill.SAYIAN_HOA_NM);
        } else if (tempId >= 1329 && tempId <= 1333) {
            return getSkillbyId(pl, Skill.SAYIAN_HOA_XD);
        } else if (tempId == 1315) {
            return getSkillbyId(pl, Skill.PHAN_TACH_TD);
        } else if (tempId == 1316) {
            return getSkillbyId(pl, Skill.PHAN_TACH_NM);
        } else if (tempId == 1317) {
            return getSkillbyId(pl, Skill.PHAN_TACH_XD);
        } else {
            return null;
        }
    }
