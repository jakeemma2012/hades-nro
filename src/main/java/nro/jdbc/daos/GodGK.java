        ...
        try {
            ...
            try {
                if (rs.next()) {
                    ...
                    dataArray = (JSONArray) JSONValue.parse(rs.getString("nhanqua"));
                    player.hasBook = Integer.parseInt(dataArray.get(0).toString());
                    player.hasUron = Integer.parseInt(dataArray.get(1).toString());
                    try {
                        player.dameOmega = Long.parseLong(dataArray.get(2).toString());
                    } catch (Exception e) {
                        player.dameOmega = 0;
                    }
                    dataArray.clear();
                    ...
                    plMp = Long.parseLong(dataArray.get(1).toString());
                    player.nPoint.mpg = Long.parseLong(dataArray.get(2).toString());
                    ...
                    plHp = Long.parseLong(dataArray.get(6).toString());
                    ...
                    player.nPoint.dameg = Long.parseLong(dataArray.get(10).toString());
                    player.nPoint.power = Long.parseLong(dataArray.get(11).toString());
                    player.nPoint.hpg = Long.parseLong(dataArray.get(12).toString());
                    dataArray.clear();
                    ...
                    for (int i = 0; i < 5; i++) {
                        player.receive[i] = Integer.parseInt(String.valueOf(dataArray.get(i)));
                    }
                    dataArray.clear();

                    dataArray = (JSONArray) jv.parse(rs.getString("eff_danhhieu"));
                    for (int i = 0; i < 5; i++) {
                        player.receiveMocSM[i] = Integer.parseInt(String.valueOf(dataArray.get(i))) != 0;
                    }
                    dataArray.clear();

                    dataArray = (JSONArray) jv.parse(rs.getString("ddanhttuan"));
                    player.DaysDiemDanh = Integer.parseInt(String.valueOf(dataArray.get(0)));
                    player.lastTimeDiemDanh = Long.parseLong(String.valueOf(dataArray.get(1)));
                    player.DaysTheTuan = Integer.parseInt(String.valueOf(dataArray.get(2)));
                    player.lastTimeRewardsTheTuan = Long.parseLong(String.valueOf(dataArray.get(3)));
                    dataArray.clear();

                    dataArray = (JSONArray) jv.parse(rs.getString("nauCa"));
                    player.itemTime.lastTimeNauCa = Long.parseLong(String.valueOf(dataArray.get(0)));
                    player.itemTime.isNauca = Integer.parseInt(String.valueOf(dataArray.get(1))) != 0;
                    dataArray.clear();

                    dataArray = (JSONArray) jv.parse(rs.getString("data_nap"));
                    player.TotalPointNap = Integer.parseInt(String.valueOf(dataArray.get(0)));
                    player.ChangePointNap = Integer.parseInt(String.valueOf(dataArray.get(1)));
                    player.m1 = Integer.parseInt(String.valueOf(dataArray.get(2))) != 0;
                    player.m2 = Integer.parseInt(String.valueOf(dataArray.get(3))) != 0;
                    player.m3 = Integer.parseInt(String.valueOf(dataArray.get(4))) != 0;
                    player.m4 = Integer.parseInt(String.valueOf(dataArray.get(5))) != 0;
                    dataArray.clear();

                    dataArray = (JSONArray) jv.parse(rs.getString("pointBanh"));
                    player.pointBossThuong = Integer.parseInt(String.valueOf(dataArray.get(0)));
                    player.pointBossVip = Integer.parseInt(String.valueOf(dataArray.get(1)));
                    try {
                        player.pointTrungThu = Integer.parseInt(dataArray.get(2).toString());
                    } catch (Exception e) {
                        player.pointTrungThu = 0;
                    }
                    try {
                        player.hasNhanquaPage = Integer.parseInt(dataArray.get(3).toString());
                    } catch (Exception e) {
                        player.hasNhanquaPage = 0;
                    }
                    try {
                        player.pointBanhKem = Integer.parseInt(dataArray.get(4).toString());
                    } catch (Exception e) {
                        player.pointBanhKem = 0;
                    }
                    try {
                        player.pointThoiVang = Integer.parseInt(dataArray.get(5).toString());
                    } catch (Exception e) {
                        player.pointThoiVang = 0;
                    }
                    try {
                        player.receiveNoiTai = Integer.parseInt(dataArray.get(6).toString()) == 1;
                    } catch (Exception e) {
                        player.receiveNoiTai = true;
                    }
                    ...
                    for (int i = 0; i < dataArray.size(); i++) {
                        dataObject = (JSONObject) dataArray.get(i);
                        int idIt = Integer.parseInt(String.valueOf(dataObject.get("idItem")));
                        long Time = Long.parseLong(String.valueOf(dataObject.get("Time")));
                        switch (idIt) {
                            case 0:
                                player.itemTime.lastTimeOpenPower = Time;
                                break;
                            case 1491:
                                break;
                            default:
                                if (Time > 0) {
                                    player.itemTime.setIsActive(idIt, Time);
                                }
                                break;
                        }
                    }
                    ...
                    if (lt != null) {
                        player.egglinhthu = new EggLinhThu(player, Long.parseLong(String.valueOf(lt)),
                                Long.parseLong(String.valueOf(dataObject.get("time_done"))),
                                Integer.parseInt(String.valueOf(dataObject.get("type"))));
                    ...
                    try {
                        player.charms.tdNoStamina = Long.parseLong(dataArray.get(10).toString());
                    } catch (Exception e) {
                    ...
                    for (int i = 0; i < dataArray.size(); i++) {
                        ...
                        if (tempId == (30 + player.gender)) {
                            player.nPoint.lvPhantachTinhThan = point;
                        }
                        Skill skill = null;
                        if (point != 0) {
                    ...
                    if (!String.valueOf(dataObject).equals("{}")) {
                        ...
                        player.fusion.lastTimeFusion = System.currentTimeMillis() - (Fusion.TIME_FUSION
                    ...
                    // player.playerTask.achivements.get(ConstAchive.LAN_DAU_NAP_NGOC).count +=
                    // session.ruby;
