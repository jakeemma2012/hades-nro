...
public class HistoryTransactionDAO {
    ...
    public static void insert(Player player1, Player player2,
        ...
        try (Connection con = DBService.gI().getConnectionForSaveHistory();) {
           ...
           ps = con.prepareStatement("insert into history_transaction(player_1,player_2,item_player_1,item_player_2,bag_1_before_tran,bag_2_before_tran,bag_1_after_tran,bag_2_after_tran,time_tran)"
                    + " values (?,?,?,?,?,?,?,?,?)");
