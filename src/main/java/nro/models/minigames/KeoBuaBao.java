    ...
    public void sendResult(byte type) {
        ...
        switch (type) {
            ...
            case 3:
                ...
                NpcService.gI().createMenuConMeo(player1, ConstNpc.IGNORE_MENU, -1,
                        String.format("|2|%s ra cái %s \n|2|Bạn ra cái %s|2|Kết quả %s", player2.name,
                                getString(player2.iDMark.KeoBuaBao), getString(player1.iDMark.KeoBuaBao),
                                resultPlayer1 == resultPlayer2 ? "Hòa"
                                        : resultPlayer1 < resultPlayer2 ? "Thua" : "Thắng"),
                        "Ok");
                NpcService.gI().createMenuConMeo(player2, ConstNpc.IGNORE_MENU, -1,
                        String.format("|2|%s ra cái %s \n|2|Bạn ra cái %s|2|Kết quả %s", player1.name,
                                getString(player1.iDMark.KeoBuaBao), getString(player2.iDMark.KeoBuaBao),
                                resultPlayer1 == resultPlayer2 ? "Hòa"
                                        : resultPlayer1 < resultPlayer2 ? "Thắng" : "Thua"),
                        "Ok");
