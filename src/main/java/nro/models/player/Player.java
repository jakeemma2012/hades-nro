...
public class Player {
    ...
    public long lastTimeDiemDanh;
    public int DaysDiemDanh;
    ...
    public long lastTimePhanTach;
    public long lastTimePickItem;
    public int pointVongQuayThuongDe;
    public int pointSk;
    ...
    public int hasBook;
    public int hasUron;
    public int pointTrungThu;

    public int TotalPointNap;
    public int ChangePointNap;
    public boolean m1;
    public boolean m2;
    public boolean m3;
    public boolean m4;
    public long dameOmega;
    public int hasNhanquaPage;

    public int[] receive = new int[5];
    public boolean[] receiveMocSM = new boolean[5];

    public int pointBossThuong;
    public int pointBossVip;

    public int pointBanhKem;
    public int pointThoiVang;
    public boolean receiveNoiTai;
    @Setter
    @Getter
    ...
    public boolean isPl() {
        return this != null && !isPet && !isBoss && !isMiniPet;
    }

    public boolean isPlnPet() {
        return this != null && !isBoss && !isMiniPet;
    }
...
//                        }
    ...
    public short getHead() {
        ...
        } else if (this.itemTime.isActive(1491)) {
            return (short) ConstPlayer.HEADMONKEY[6];
    ...
    public short getBody() {
        ...
        if (effectSkill != null && effectSkill.isMonkey || this.itemTime.isActive(1491)) {
            return 193;
        } else if (effectSkill != null && effectSkill.isSaiYan) {
