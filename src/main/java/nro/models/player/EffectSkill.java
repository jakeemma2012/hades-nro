...
public class EffectSkill {
    ...
    public byte levelSaiYan;
    public long lastTimeUpSaiYan;
    public int timeSaiYan;
...
//    public int timeAnTroi;
    ...
    public void removeSkillEffectWhenDie() {
        ...
        if (isSaiYan) {
            EffectSkillService.gI().saiYanDown(player);
        }
        if (isShielding) {
    ...
    public void update() {
        if (isMonkey && (Util.canDoWithTime(lastTimeUpMonkey, timeMonkey))) {
          ...
          if (isSaiYan && (Util.canDoWithTime(lastTimeUpSaiYan, timeSaiYan))) {
            EffectSkillService.gI().saiYanDown(player);
        }
