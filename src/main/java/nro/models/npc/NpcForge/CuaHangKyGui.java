...
public class CuaHangKyGui extends Npc {
    ...
    public void openBaseMenu(Player player) {
        if (canOpenNpc(player)) {
            // this.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Xin chào ? Cậu đang làm
            // gì ở đây vậy ?!", "Đóng");
                    ...
                    switch (select) {
                        case 0:
                            Service.getInstance().sendPopUpMultiLine(player, tempId, avartar,
                                    "Cửa hàng chuyên nhận ký gửi mua bán vật phẩm\bGiá trị ký gửi 10k-200Tr vàng hoặc 2-2k ngọc\bMột người bán, vạn người mua, mại dô, mại dô");
                            break;
                        case 1:
