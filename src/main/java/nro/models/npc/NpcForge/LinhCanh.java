...
public class LinhCanh extends Npc {
    ...
    public void openBaseMenu(Player player) {
        if (canOpenNpc(player)) {
            this.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Xin chào ! Bạn đang làm gì ở đây vậy ?", "Đóng");
        }
        // return;
        // if (player.clan == null) {
        ...
        // return;
        // }
        // int days = (int) (((System.currentTimeMillis() / 1000) - clanMember.joinTime)
        // / 60 / 60 / 24);
        // if (days < 2) {
        // NpcService.gI().createTutorial(player, avartar,
        // "Chỉ những thành viên gia nhập bang hội tối thiểu 2 ngày mới có thể tham
        // gia");
        // return;
        // }
        ...
        // "Bang hội chỉ cho phép những người ở trong bang trên 1 ngày. Hẹn ngươi quay
        // lại vào lúc khác",
        // "OK", "Hướng\ndẫn\nthêm");
