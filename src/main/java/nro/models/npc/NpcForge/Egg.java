        ...
        if (canOpenNpc(player)) {
            if (this.mapId == (21 + player.gender)) {
                ...
                if (player.mabuEgg.getSecondDone() != 0) {
                    this.createOtherMenu(player, ConstNpc.CAN_NOT_OPEN_EGG, "Bư bư bư...\n"
                            + "Bạn có muốn mở trứng không ?\n"
                            + "Sau khi mở thành công, bạn sẽ nhận được ngẫu nhiên 2 loại đệ tử :\n"
                            + "Mabu : tăng 30% HP và 10% HP,SD\n"
                            + "Mabu ròm : tăng 30% SD và 10% HP,KI\n"
                            + "Kid Bu : tăng 30% KI và 10% SD,HP\n"
                            + "Chỉ số chỉ có tác dụng khi hợp thể\n"
                            + "Bư bư bư.....",
                            "Hủy bỏ\ntrứng", "Nở nhanh\n 1 tỉ vàng", "Đóng");
                } else {
            ...
            if (this.mapId == 191) {
                if (player.egglinhthu != null) {
                    ...
                    this.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Quả trứng linh thú\n Nở sau "
                            + player.egglinhthu.getSecondDone() + " giây nữa", "Đóng");
                } else {
