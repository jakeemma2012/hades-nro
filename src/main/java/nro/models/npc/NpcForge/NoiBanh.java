                ...
                case ConstNpc.BASE_MENU:
                    switch (select) {
                        ...
                        case 2:// banh 1 trung
                            ...
                            // Service.getInstance().sendThongBao(player, "Bắt đầu nấu bánh,thời gian nấu
                            // bánh là 5 phút");
                            // } else {
                            // Service.getInstance().sendThongBao(player, "Không đủ nguyên liệu hoặc 2 nghìn
                            // ruby");
                            // }
                        ...
                        case 3:// banh 2 chung
                            ...
                            // } else {
                            // Service.getInstance().sendThongBao(player, "Không đủ nguyên liệu hoặc 5 nghìn
                            // ruby");
                            // }
                        ...
                        case 4:
                            ...
                            if (carot != null && player.inventory.gold >= COST_DOI_BANH) {
                                ...
                                Service.getInstance().sendThongBao(player,
                                        "Không đủ nguyên liệu hoặc 1 tỷ vàng để đổi");
                            }
                            break;
                    }
                    break;
