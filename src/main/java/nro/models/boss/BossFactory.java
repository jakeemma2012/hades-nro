...
import nro.models.boss.BongToi.Bu_Bongtoi;
import nro.models.boss.BongToi.Buibui_Bongtoi;
import nro.models.boss.BongToi.HidraBula_Bongtoi;
import nro.models.boss.BongToi.Yacon_Bongtoi;
import nro.models.boss.NgucTu.Cumber;
import nro.models.boss.NgucTu.SuperCumber;
import nro.models.boss.Omega.OmegaPlus;
import nro.models.boss.SieuDoanhDoan.HongHoa;
import nro.models.boss.SieuDoanhDoan.Khi6;
import nro.models.boss.SieuDoanhDoan.QuyLao;
import nro.models.boss.SieuDoanhDoan.SieuOmega;
...
import nro.models.boss.cereal.Elec;
import nro.models.boss.cereal.Gas;
import nro.models.boss.cereal.Granola;
import nro.models.boss.cereal.Mackie;
import nro.models.boss.cereal.Oli;
...
import nro.models.boss.traidat.LanCon;
import nro.models.boss.traidat.LanCon1;
import nro.models.boss.traidat.LanCon2;
import nro.models.map.Map;
import nro.models.map.Zone;
import nro.models.map.mabu.MabuWar;
import nro.models.map.mabu.MabuWar14h;
import nro.models.phuban.MabuBoss.MabuPhuBan;
import nro.models.phuban.MabuBoss.MabuRom;
...
public class BossFactory {
    ...
    public static final byte TRUNG_UY_THEP = -5;
    ...
    public static final int MABU_PHUBAN = -141;

    public static final int MABU_BONGTOI = -142;
    public static final int BUIBUI_BONGTOI = -143;
    public static final int YACON_BONGTOI = -144;
    public static final int HIDRABULA_BONGTOI = -145;
    public static final int MABU_ROM = -146;

    public static final int LANCON = -147;
    public static final int LANCON1 = -148;
    public static final int LANCON2 = -149;

    public static final int QUY_LAO = -150;
    public static final int KHI_6 = -151;
    public static final int HOAHONG = -152;

    public static final int ZAMASU = -153;
    public static final int ZAMASU2 = -154;

    public static final int BLACKGOKU_1 = -155;
    public static final int BLACKGOKU_2 = -156;

    public static final int GRANOLA = -157;
    public static final int OLI = -158;
    public static final int GAS = -159;
    public static final int MACKIE = -160;
    public static final int ELEC = -161;
    ...
    public static void initBoss() {
        new Thread(() -> {
            try {
                ...
                createBoss(BLACKGOKU_1);
                createBoss(BLACKGOKU_2);
    ...
    public static Boss createBoss(int bossId) {
        ...
        switch (bossId) {
            ...
            case MABU_ROM:
                ...
                break;
            case TRUNG_UY_TRANG:
                boss = new nro.models.boss.SieuDoanhDoan.TrungUyTrang();
                break;
            case TRUNG_UY_XANH_LO:
                boss = new nro.models.boss.SieuDoanhDoan.TrungUyXanhLo();
                break;
            case TRUNG_UY_THEP:
                boss = new nro.models.boss.SieuDoanhDoan.TrungUyThep();
                break;
            case YACON_BONGTOI:
                boss = new Yacon_Bongtoi();
                break;
            case HIDRABULA_BONGTOI:
                boss = new HidraBula_Bongtoi();
                break;
            case BUIBUI_BONGTOI:
                boss = new Buibui_Bongtoi();
                break;
            case MABU_BONGTOI:
                boss = new Bu_Bongtoi();
                break;
