...
public class Superblackgoku extends Boss {
    ...
    public void joinMap() {
        ...
        // ServerNotify.gI().notify("Boss " + this.name + " vừa xuất hiện tại " +
    ...
    public void leaveMap() {
        ...
        Boss zsm = this.zone.getBossInMap(BossFactory.ZAMASU);
        if (zsm != null && !zsm.isDie()) {
            ...
            ChangeMapService.gI().changeMapYardrat(superZamasu, superZamasu.zone, x,
                    y - 24);
