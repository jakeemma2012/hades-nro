        ...
        try {
            ...
            if (Util.getDistance(this, pl) <= this.getRangeCanAttackWithSkillSelect()) {
                ...
                if (ChronoUnit.SECONDS.between(this.last_time_attack, LocalDateTime.now()) >= 10) {
                    ...
                    NoelBossBall ball1 = BossFactory.createNoelBossBall(BossFactory.NOEL_BOSS_BALL_2,
                            playerCanAttack.get(1), this);
                    NoelBossBall ball2 = BossFactory.createNoelBossBall(BossFactory.NOEL_BOSS_BALL_3,
                            playerCanAttack.get(2), this);
                    NoelBossBall ball3 = BossFactory.createNoelBossBall(BossFactory.NOEL_BOSS_BALL_4,
                            playerCanAttack.get(3), this);
                    NoelBossBall ball4 = BossFactory.createNoelBossBall(BossFactory.NOEL_BOSS_BALL_5,
                            playerCanAttack.get(4), this);
